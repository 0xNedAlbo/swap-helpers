...
contract DaiUsdcSwapTest is UniswapV3HelperTest {
    ...
    function test_30_buyToken1_revertsOnDeviationFromOracle() public virtual override {
        vm.skip(true);
    }

    function test_30_sellToken0_revertsOnDeviationFromOracle() public virtual override {
        vm.skip(true);
    }

    function test_30_sellToken1_revertsOnDeviationFromOracle() public virtual override {
        vm.skip(true);
    }
