...
interface IUniV3Swapper {
    ...
    function previewSellA(uint256 amountA) external returns (uint256);

    function previewSellB(uint256 amountB) external returns (uint256);

    function previewBuyA(uint256 amountA) external returns (uint256);

    function previewBuyB(uint256 amountB) external returns (uint256);
